...
The goal of this program is straightforward — to display the text **“Hello World”** on the screen, confirming that the code runs successfully. Although basic, this is a fundamental steps in building confidence with the programming workflow and development tools.
